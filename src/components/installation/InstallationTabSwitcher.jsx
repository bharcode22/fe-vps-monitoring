  ...
  return (
    <div className="flex flex-wrap items-center bg-slate-950/90 p-1.5 rounded-2xl border border-cyan-500/20 shadow-lg gap-1.5">
      ...
      <button
        ...
        className={`flex-1 min-w-[130px] py-2 px-2.5 rounded-xl text-xs font-extrabold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
          activeTab === 'backend'
      ...
      <button
        ...
        className={`flex-1 min-w-[140px] py-2 px-2.5 rounded-xl text-xs font-extrabold flex items-center justify-center gap-1.5 transition-all cursor-pointer ${
          activeTab === 'bundles' || activeTab === 'bundle_deploy'
