    ...
    <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
      ...
      <div className="cursor-pointer" onClick={onNavigateHome}>
        <div className="flex items-center gap-1.5 sm:gap-2">
          ...
          <span className="text-[9px] font-bold px-1.5 py-0.2 rounded bg-cyan-500/15 text-cyan-400 border border-cyan-500/30 font-mono">
            PRO
          </span>
          <span
            ...
            title={isConnected ? 'Terhubung ke server monitoring (Live)' : 'Koneksi ke server terputus'}
          />
        </div>
      </div>
    </div>
