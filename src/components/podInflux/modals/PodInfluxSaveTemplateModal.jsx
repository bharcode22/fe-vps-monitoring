...
export default function PodInfluxSaveTemplateModal({
  isOpen,
  onClose,
  isEditMode,
  templateForm,
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="pt-3 border-t border-slate-800 flex items-center justify-end gap-2">
          ...
          <button
            ...
            className={`px-4 py-2 text-white font-semibold text-xs rounded-lg shadow-lg flex items-center gap-1.5 transition disabled:opacity-50 ${
              isEditMode
