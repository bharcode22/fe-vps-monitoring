    ...
    <div className="flex flex-col gap-5 animate-pulse">
      ...
      <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-3.5 flex flex-wrap items-center justify-between gap-3 shadow-sm">
        ...
        <div className="flex items-center gap-3">
          <div className="h-8 w-44 bg-slate-800/60 rounded-xl"></div>
          <div className="h-8 w-36 bg-slate-800/80 rounded-xl"></div>
        </div>
      </div>
        ...
        <table className="w-full text-left text-xs border-collapse">
          <thead>
            <tr className="bg-slate-950/80 border-b border-slate-800">
              <th className="p-3.5 w-72"><div className="h-3.5 w-36 bg-slate-800 rounded"></div></th>
              <th className="p-3.5 text-center w-28"><div className="h-3.5 w-20 bg-slate-800 rounded mx-auto"></div></th>
          ...
          <tbody className="divide-y divide-slate-800/50">
            {[1, 2, 3, 4, 5, 6].map((row) => (
              <tr key={row} className="hover:bg-transparent">
                <td className="p-3.5">
                  <div className="h-4 w-44 bg-slate-800/90 rounded mb-1.5"></div>
                  <div className="h-2.5 w-28 bg-slate-800/40 rounded"></div>
                </td>
                <td className="p-3.5 text-center">
                  <div className="h-5 w-12 bg-slate-800/80 rounded-full mx-auto"></div>
                </td>
                <td className="p-3.5 text-center">
