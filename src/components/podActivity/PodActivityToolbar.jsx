    ...
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-slate-900/60 border border-slate-800 p-3 rounded-2xl">
      ...
      <div className="relative flex-1 max-w-md">
        ...
        <input
          ...
          className="w-full bg-slate-950 border border-slate-800 text-slate-200 text-xs rounded-xl pl-9 pr-3.5 py-2 focus:outline-none focus:border-cyan-500 transition-colors font-medium placeholder:text-slate-500"
        />
      </div>
