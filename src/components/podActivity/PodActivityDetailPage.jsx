...
export default function PodActivityDetailPage({ pod, onBack }) {
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      {/* Page Header */}
      <div className="flex items-center gap-4 bg-slate-900/60 p-4 rounded-2xl border border-slate-800 backdrop-blur-md">
        <button
          onClick={onBack}
      ...
      <PodActivityTopicCards 
        ...
        pods={[pod]} // Only pass this pod to the filter
      />
    </div>
  );
}
