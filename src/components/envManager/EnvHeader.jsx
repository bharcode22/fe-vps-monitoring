      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-slate-400 text-xs mt-0.5">
            Kelola file .env, edit konfigurasi variabel, dan bandingkan nilai antar environment secara visual
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        ...
        {activeTab === 'editor' && selectedFile && (
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-extrabold flex items-center gap-2 transition-all shadow-md cursor-pointer ${
              isDirty
